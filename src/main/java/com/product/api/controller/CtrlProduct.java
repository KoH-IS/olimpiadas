...
public class CtrlProduct {
	...
	public ResponseEntity<List<DtoProductList>> getProductCategory(@PathVariable("category_id") Integer category_id){
		return new ResponseEntity<>(svc.getProductCategory(category_id), HttpStatus.OK);
	}
	...
	public ResponseEntity<ApiResponse> updateProductStock(@PathVariable("gtin") String gtin, @RequestParam("stock") Integer stock){
